...
public class EmployeeappApplication {
	...
	public CommandLineRunner commandLineRunner(){
		return args -> {
			...
			List<Employee> employees=employeeRepo.findByDepartmentDname("sales");
//
			employees.forEach(e-> System.out.println(e));

//
//			List<DeptEmpResponse> deptEmpResponses=
//					departmentRepo.deptEmployeeData();
//			deptEmpResponses.forEach(r-> System.out.println(r));
			
//			List<Department> departmentsCompleteData = departmentRepo.findAll();
//			departmentsCompleteData.forEach(d -> System.out.println(d));
